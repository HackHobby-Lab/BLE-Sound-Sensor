...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MPSL_CALIBRATION_PERIOD, 2000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CLOCK_CONTROL_NRF_CALIBRATION_PERIOD, 2000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CLOCK_CONTROL_NRF_CALIBRATION_MAX_SKIP, 0);
